...
Or if you are scared of running python but not scared of random .EXEs on the internet, there is an executable located in the /dist folder of this repo that will launch the application with no python-fuss required (Windows only, sorry).
